    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">{lang || "Code"}</span>
        </div>
        <button onClick={copyCode} aria-label="Copy code" className="text-gray-700 focus:outline-none relative group">
          {copied ? (
